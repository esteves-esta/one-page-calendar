...
function SvgLearning() {
  ...
  function changeColorTurbulence() {
    setDegree(degree + 40);
  }
  ...
  return (
    <>
      ...
      >
        ...
        <g id="tv-screen" onClick={changeColorTurbulence}>
          <rect
            x="1.5"
            y="3.5"
            width="6.5"
          ...
          <text x="3" y="6" fontSize={0.1} fill="white" fontFamily="Arial">
        ...
        <g id="control">
          ...
          <g id="btn" onClick={changeColorTurbulence}>
            <circle
              cx="9.5"
              cy="5.3"
              r={0.5}
